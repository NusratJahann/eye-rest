      ...
      <div className="flex flex-col justify-center items-center min-h-screen min-w-full">
        <div>
          ...
          <div className="flex justify-evenly px-16 mt-6">
            <button
              className="btn btn-neutral p-2 rounded-full"
              onClick={restart}>
              <svg
            ...
            <button className={isRunning ? "btn btn-neutral p-2 rounded-full" : "btn btn-primary p-2 text-neutral rounded-full"} onClick={pauseAndResume}>
              {isRunning ? (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <button className="btn btn-neutral p-2 rounded-full">
